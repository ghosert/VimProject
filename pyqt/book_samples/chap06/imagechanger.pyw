...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        # saveGeometry and restoreGeometry can be used to replace save/restore the point and size of the Window.
        self.restoreState(settings.value("MainWindow/State").toByteArray())
        # saveState and restoreState only work for the dock window or toolbar which has unique object name,
        # that's why we need set object name to them above.
        
        self.setWindowTitle("Image Changer")
        self.updateFileMenu()
        # when you are doing lots of processing at Start-Up, always remember to use QTimer.singleShot(0, callableObject)
        # this will make the callable method is called after main window is shown.
