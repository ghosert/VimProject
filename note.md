...
- [ ] [SD: 2024-06-07] dockerize the entirement runtime env to docker based on Ubuntu 22.04, verify all features and make sure it works no issue, check all TODO under ~/docker
