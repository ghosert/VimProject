...
7. `:Gt 'any commnets'` to cd to current file location and run !git commit -a -m 'any comments'
8. `:Gs` for git status, `:Gh` for git push, `:Gl` for git pull, `:Gf` for git diff
